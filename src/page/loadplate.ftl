...
<!-- 样式引入区 start-->
<link rel="stylesheet" href="${BASE_PATH}/static/css/page/magic/workshop/loadplate.css?45b904576bdff6af14e492d12286aead"/>
<!-- 样式引入区 end-->
...
<!-- 脚本引入区 start -->
<script  src="${BASE_PATH}/static/js/page/magic/workshop/loadplate.js?f46adee862c3c4542f399e5d8c013ecf"></script>
<!-- 脚本引入区 end -->